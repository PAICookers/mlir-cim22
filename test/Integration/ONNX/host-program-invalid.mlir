...
module {
  ...
  func.func @consume_before_barrier(%input: tensor<64xi8>)
    ...
    ^bb0(%transaction_input: tensor<64xi8>):
      ...
      %readback = cim.readback {cim.mapping = {core_coord = array<i64: 0, 0>, destination = array<i64: 0, 0>, ingress = array<i64: 0, 0>, route = array<i64: 0, 0, 0, 0, 0, 0>, source = array<i64: 0, 0>}, core_idx = 0 : i64, group_id = 0 : i64, k_tile = 0 : i64, m_tile = 0 : i64, macro_idx = 0 : i64, n_tile = 0 : i64, work_id = 0 : i64} : tensor<16xi21>
      // expected-error@+1 {{Host operations are not allowed inside cim.transaction}}
      %extended = arith.extsi %readback : tensor<16xi21> to tensor<16xi32>
      cim.group_barrier {group_id = 0 : i64}
      "cim.yield"(%readback) : (tensor<16xi21>) -> ()
