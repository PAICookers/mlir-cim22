...
// CHECK: cim.vmm {{.*}} {cim.transaction_idx = 0 : i64, group_id = 0 : i64, k_tile = 0 : i64, m_tile = 0 : i64, n_tile = 0 : i64, work_id = 0 : i64}
// CHECK: cim.vmm {{.*}} {cim.transaction_idx = 0 : i64, group_id = 0 : i64, k_tile = 1 : i64, m_tile = 0 : i64, n_tile = 0 : i64, work_id = 1 : i64}
// CHECK: cim.vmm {{.*}} {cim.transaction_idx = 0 : i64, group_id = 1 : i64, k_tile = 0 : i64, m_tile = 0 : i64, n_tile = 1 : i64, work_id = 2 : i64}
// CHECK: cim.vmm {{.*}} {cim.transaction_idx = 0 : i64, group_id = 1 : i64, k_tile = 1 : i64, m_tile = 0 : i64, n_tile = 1 : i64, work_id = 3 : i64}
// CHECK: cim.vmm {{.*}} {cim.transaction_idx = 0 : i64, group_id = 2 : i64, k_tile = 0 : i64, m_tile = 1 : i64, n_tile = 0 : i64, work_id = 4 : i64}
// CHECK: cim.vmm {{.*}} {cim.transaction_idx = 0 : i64, group_id = 2 : i64, k_tile = 1 : i64, m_tile = 1 : i64, n_tile = 0 : i64, work_id = 5 : i64}
// CHECK: cim.vmm {{.*}} {cim.transaction_idx = 0 : i64, group_id = 3 : i64, k_tile = 0 : i64, m_tile = 1 : i64, n_tile = 1 : i64, work_id = 6 : i64}
// CHECK: cim.vmm {{.*}} {cim.transaction_idx = 0 : i64, group_id = 3 : i64, k_tile = 1 : i64, m_tile = 1 : i64, n_tile = 1 : i64, work_id = 7 : i64}
