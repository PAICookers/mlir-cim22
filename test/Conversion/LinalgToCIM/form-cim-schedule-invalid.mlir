...
func.func @mixed_schedule(%input: tensor<64xi8>,
  ...
  %1 = cim.vmm %input, %weight {cim.transaction_idx = 0 : i64, m_tile = 0 : i64, n_tile = 0 : i64,
      k_tile = 1 : i64}
      : tensor<64xi8>, tensor<16x64xi8> -> tensor<16xi21>
  return
}
...
func.func @incomplete_rectangle(%input: tensor<64xi8>,
  ...
  %0 = cim.vmm %input, %weight {cim.transaction_idx = 0 : i64, m_tile = 0 : i64, n_tile = 0 : i64,
      k_tile = 0 : i64}
      : tensor<64xi8>, tensor<16x64xi8> -> tensor<16xi21>
  %1 = cim.vmm %input, %weight {cim.transaction_idx = 0 : i64, m_tile = 0 : i64, n_tile = 1 : i64,
      k_tile = 1 : i64}
      : tensor<64xi8>, tensor<16x64xi8> -> tensor<16xi21>
  return
}
...
func.func @dependent_pair(%input: tensor<64xi8>,
  ...
  %1 = cim.vmm %dependent_input, %weight {cim.transaction_idx = 0 : i64, m_tile = 0 : i64,
