...
// RUN: mlir-cim22-opt %t/negative.mlir -partition-cim-program -form-cim-program --mlir-print-op-generic --mlir-print-local-scope | FileCheck %s --check-prefix=NEG --implicit-check-not='"cim.vmm"'
