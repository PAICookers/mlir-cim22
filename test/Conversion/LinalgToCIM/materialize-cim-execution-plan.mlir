...
// CHECK-NEXT: cim.configure_weight @__cim_weight_two_work_s0_w0 {{.*}}macro_slot = 0 : i64
// CHECK-NEXT: cim.configure_input %arg1 {{.*}}macro_slot = 1 : i64
// CHECK-NEXT: cim.configure_weight @__cim_weight_two_work_s0_w1 {{.*}}macro_slot = 1 : i64
...
// CHECK-NEXT: cim.group_barrier {cim.segment_id = 0 : i64, group_id = 0 : i64}
